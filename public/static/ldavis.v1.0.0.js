...
var LDAvis = function (to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        var d3div=d3.select(to_select).append("div").attr("id","d3div")
        getSlider("d3div")
        ...
        var svg2 = d3.select(to_select).append("svg")
            .attr("width", 490)
            .attr("height", mdsheight + 2 * margin.top + margin.bottom + 2 * rMax)
            .attr("id","svg2")
        // getSlider("svg2");
        ...
        var chart = svg2.append("g")
            ...
            // .attr("transform", "translate(" + margin.left + "," + 2 * margin.top + ")")
            .attr("transform", "translate(" + "40" + "," + 2 * margin.top + ")")
            .attr("id", barFreqsID);
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; width: " + 490 + "px; float: left");
            ...
            // lambdaDiv.setAttribute("style", "padding: 5px; display: block; height: 50px; width: " + lambdaDivWidth + "px;");
            // inputDiv.appendChild(lambdaDiv);
            //
            // var lambdaZero = document.createElement("div");
            // // lambdaZero.setAttribute("style", "padding: 5px; height: 20px; width: 220px; font-family: sans-serif; float: left;display:inline-block");
            // lambdaZero.setAttribute("style", "padding: 0px; height: 20px; width: 220px; font-family: sans-serif; float: left;display:inline-block");
            ...
            // sliderDiv.setAttribute("style", " height: 40px; width: 10px; float: right;  margin-right: 150px;display:inline-block");
            //
            ...
            // // lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px;margin-left: 80px ;display:inline-block");
            // lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px;margin-left: 20px ;display:inline-block");
        ...
        function getSlider(id){
            ...
            // lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 50px; width: " + lambdaDivWidth + "px; float: right; margin-right: 30px");
            // lambdaDiv.setAttribute("style", "padding: 5px; display: block; height: 50px; width: " + lambdaDivWidth + "px;");
            lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 50px; width: 490px;");
            document.getElementById(id).appendChild(lambdaDiv);

            var lambdaZero = document.createElement("div");
            // lambdaZero.setAttribute("style", "padding: 5px; height: 20px; width: 220px; font-family: sans-serif; float: left;display:inline-block");
            lambdaZero.setAttribute("style", "padding: 0px; height: 30px; width: 220px; font-family: sans-serif; float: left;display:inline-block");
            lambdaZero.setAttribute("id", lambdaZeroID);
            lambdaDiv.appendChild(lambdaZero);
            var xx = d3.select("#" + lambdaZeroID)
                .append("text")
            ...
            // sliderDiv.setAttribute("style", "padding: 5px; height: 40px; width: 250px; float: right; margin-top: -5px; margin-right: 10px");
            // sliderDiv.setAttribute("style", " height: 40px; width: 10px; float: right;  margin-right: 150px;display:inline-block");
            sliderDiv.setAttribute("style", " height: 40px; width: 250px; float: right; margin-top: -20px; display:inline-block");
            // lambdaDiv.appendChild(sliderDiv);
            ...
            // lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px;margin-left: 80px ;display:inline-block");
            // lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px;margin-left: 20px ;display:inline-block");
            lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px; margin-left: 80px;display:block");
            lambdaLabel.innerHTML = "&#955 = <span id='" + lambdaID + "-value'>" + vis_state.lambda + "</span>";
            lambdaDiv.appendChild(lambdaLabel);
            lambdaDiv.appendChild(sliderDiv);
            // Create the svg to contain the slider scale:
